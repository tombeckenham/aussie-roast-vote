...
export async function processPolicyPerplexityData(
  ...
  try {
    ...
    console.log(`Extracted polices for ${candidateName}:`, extractedPolicies);
    ...
    const prompt = `
      ...
      1 sentence is enough. Don't include g'day, mate, crikey or any preamble. Just get straight into it.
